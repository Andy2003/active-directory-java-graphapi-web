...
<li class="horiNavBar"><a class="horiNavBar" href="requestHandler?op=about">About</a></li>
</ul>
</div>
 	...
 	<tr>
 		...
 		<%
 			if(user.getManagerDisplayName() != null){
 				out.println("<a class=\"users\" href='requestHandler?op=getuser&ObjectId=" +  user.getManagerObjectId()+"'>" +user.getManagerDisplayName()+"</a>");
 			}
 		%>
 		</td>
	</tr>
 	...
 	<tr>
 		...
 		<%	
 			for(int i = 0; i < user.getDirectReportNumber(); i++ ){
 	 				...
 	 				out.println("<a class=\"users\" href='requestHandler?op=getuser&ObjectId=" +  user.getDirectReportObjectId(i) + "'>" + user.getDirectReportDisplayName(i)+"</a>");
 					out.println("<br>");
 			}
 	...
 	<tr>
 		...
 		<%	
 			for(int i = 0; i < user.getGroupNumber(); i++ ){
 	 				...
 	 				out.println("<a class=\"users\" href='requestHandler?op=getgroup&ObjectId=" +  user.getGroupObjectId(i) + "'><b>" + user.getGroupDisplayName(i)+"</b></a>");
 					out.println("<br>");
 			}
 	...
 	<tr>
 		...
 		<%	
 			for(int i = 0; i < user.getRolesNumber(); i++ ){
 	 				...
 	 				out.println("<a class=\"users\" href='requestHandler?op=getrole&roleId=" +  user.getRoleObjectId(i) + "'><b>" + user.getRoleDisplayName(i)+"</b></a>");
 					out.println("<br>");
 			}
